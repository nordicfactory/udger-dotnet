...
";
        ...
        /// Device columns list.
        /// </summary>
        public const string DeviceColumns = @"
...
";
        ...
        /// Query for device.
        /// </summary>
        public static readonly string SqlDevice = $@"
        SELECT
            ur.rowid,
            {DeviceColumns}
        FROM
...
";
        ...
        /// </summary>
        public static readonly string SqlClientClass = $@"
        SELECT
            {DeviceColumns}
        FROM
...
";
        ...
        /// Query for IP.
        /// </summary>
        public static readonly string SqlIp = $@"
        SELECT
            {IpColumns}
        FROM
            udger_ip_list
...
";
        ...
        /// </summary>
        public static readonly string SqlDatacenterRange6 = $@"
        SELECT
            {DatacenterColumns}
        FROM
...
";
        ...
        /// </summary>
        public const string SqlDeviceRegex = @"
        SELECT
            id,
            regstring
        FROM
...
";
        ...
        /// </summary>
        public const string SqlDeviceNameList = @"
        SELECT
            marketname,
            brand_code,
            brand,
